      ...
      <div className="content">
        <div className="container">
          ...
          <sectin className="content__block">
            ...
            <p className="content__text">Место проведения: ул. Октябрьская, 16А – EventSpace. Парковка и вход через ул.
              Октябрьскую, 10б.</p>
          </sectin>
            ...
            <ul className="speaker">
              <li className="speaker__item">
                ...
                <div className="speaker__item-info">
                  ...
                  <small className="speaker__item-overview">Сделает введение в язык и расскажет об основных особенностях
                    языка
                  </small>
                </div>
              </li>
              <li className="speaker__item">
                <picture className="speaker__item-pic">
                  <img className="speaker__item-img" src={require('../speakers/photos/ruslan_ibragimov.jpg')}
                       alt="MDN"/>
                </picture>
                <div className="speaker__item-info">
